...
<div class="incident-steps-form">
    ...
    <?= $form->field($importance, 'ref_importance_id')->widget(Select2::classname(),[
        ...
        'language' => 'ru',
        'pluginEvents' => [
            "select2:select" => "function() { var alerts; alerts = $('#incident-steps-create-form').serialize();$.get('create',alerts+'&ref_type_steps_id=$ref_type_steps_id&incident_id=$incident_id',function(data){ $('#incident-steps-create-form').replaceWith(data);});} "],
    ])?> <?php endif ?>
